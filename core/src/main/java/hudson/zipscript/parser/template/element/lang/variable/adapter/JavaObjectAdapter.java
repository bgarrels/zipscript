...
public class JavaObjectAdapter implements ObjectAdapter {
	...
	public Object call(String key, Object[] parameters, Object object) {
		Method m = BeanUtil.getPropertyMethod(
	...
	public Object get(
			String key, Object object, RetrievalContext context, String contextHint) {
		Object obj = getMethods.get(key);
		if (null == getMethods.get(key)) {
			Method method = BeanUtil.getPropertyMethod(
					object, key, NO_PARAMS);
			if (null != method) {
				getMethods.put(key, method);
				obj = method;
			}
			else {
				UnknownPropertyException e = new UnknownPropertyException(key, object);
	...
	public void set(String key, Object value, Object object) {
		...
		Method m = BeanUtil.getPropertyMethod(
				object, "set" + StringUtil.firstLetterUpperCase(key), params);
		if (null != m) {
			try {
