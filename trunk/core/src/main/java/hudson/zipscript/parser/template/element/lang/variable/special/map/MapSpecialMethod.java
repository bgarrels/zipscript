...
public abstract class MapSpecialMethod implements SpecialMethod {
	...
	public final Object execute(Object source, RetrievalContext retrievalContext,
			...
			throws Exception {
		if (null == mapAdapter) {
			mapAdapter = context.getResourceContainer().getVariableAdapterFactory().getHashAdapter(source);
		}
		return execute(source, mapAdapter, retrievalContext, contextHint, context);
	}

	protected abstract Object execute (
			Object source, HashAdapter mapAdapter, RetrievalContext retrievalContext, String contextHint, ExtendedContext context);
